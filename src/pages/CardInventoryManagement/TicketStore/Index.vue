        ...
        <a-row :gutter="16" type="flex">
          <a-col :xs="24" :md="16" :lg="16">
            ...
            <a-table
              ...
              :pagination="dataNow.length === 0 ? false : pagination"
              :loading="loading"
              :scroll="{ x: '100%' }"
          ...
          <a-col :xs="24" :md="8" :lg="8">
            ...
            <a-table
              ...
              :data-source="dataDetailNow"
              :rowKey=" (rowKey, index ) => index"
              :pagination="dataDetailNow.length === 0 ? false : paginationDetail"
              :loading="loading"
              :scroll="{ x: '100%' }"
              :locale="{ emptyText: 'Chưa có dữ liệu' }"
              @change="handleTableChange"
